let
  ...
  userPi = "ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAIFjdbT/pxlfzMJjfnDWhk2EwWt809M/YsP2vABRjRtXu legendofmiracles@protonmail.com";
  users = [ user1 userPi ];

  system1 = "ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAIMtX31mOmvoI97JCoNGDjo8Nqker9tid14Pkz/LklRIQ";
  piSystem = "ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAIH9Iplu28K+DBrpEcTdQ+wS8yNmSaCCvzuhYOspoyWR4";
